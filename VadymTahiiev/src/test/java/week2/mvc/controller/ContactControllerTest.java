...
public class ContactControllerTest {
    ...
    public void filterByCity() throws Exception {
        ...
        contactController.addContact(new Contact("Andrey", "+380939876543","Los Angelas"));
        contactController.addContact(new Contact("Oleg", "+380974536723","Los angelas"));
        contactController.addContact(new Contact("Ivan", "+380507869078","Warsaw"));

        Contact[] contacts = contactController.filterByCity("Los Angelas");
        Assert.assertEquals(2,contacts.length);
    }

    @Test
    public void mergeContacts() throws Exception {
        Contact[] contacts1 = {new Contact("Anton", "+380931234567"),
                new Contact("Andrey", "+380939876543"),
                new Contact("Vadym", "+380939876000")};

        Contact[] contacts2 = {new Contact("Oleg", "+380974536723"),
                new Contact("Ivan", "+380507869078")};

        Contact[] mergedContacts = contactController.mergeContacts(contacts1,contacts2);

        Assert.assertEquals(5,mergedContacts.length);
    }
